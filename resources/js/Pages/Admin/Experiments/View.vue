        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6 text-white">
                <div class="grid grid-cols-6 grid-rows-2 gap-4">
                    <div class="col-span-2 row-span-2 p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                        <header>
                        ...
                        <section class="mt-5">
                            <div class="flex flex-col gap-6 w-full text-gray-900 dark:text-gray-200">
                                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">{{ experiment.name }}</h2>
                                <div class="first-letter:uppercase font-semibold text-sm">Estado: {{ experiment.status }}</div>
                                <div class="first-letter:uppercase font-semibold text-sm">Descripcion: {{ experiment.description }}</div>
                                <div class="first-letter:uppercase font-semibold text-sm">Tiempo limite: {{ experiment.time_limit }}</div>
