    ...
    <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <a href="javascript:;" :class="linkClasses('experiments')">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <a href="javascript:;" :class="linkClasses('games')">
                            <Dropdown align="right" width="48">
                                <template #trigger>
                                    <span class="inline-flex rounded-md">
                                        <button type="button"
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <a href="javascript:;" :class="linkClasses('schools')">
                            <Dropdown align="right" width="48">
                                <template #trigger>
                                    <span class="inline-flex rounded-md">
                                        <button type="button"
                                ...
                                <template #content>
                                    <DropdownLink :href="route('schools.index')"> Todos los colegios </DropdownLink>
                                    <DropdownLink :href="route('schools.create')"> Nuevo colegio </DropdownLink>
                                </template>
                            </Dropdown>
                        </a>
                    </div>
        ...
        <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }" class="sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <a href="javascript:;" :class="linkClasses('experiments', true)">
                    <Dropdown align="right" width="48">
                        <template #trigger>
                            <span class="inline-flex rounded-md">
                                <button type="button"
                                    class="w-full inline-flex items-center border-transparent text-sm leading-4 font-medium text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                                    Experimentos
                ...
                <a href="javascript:;" :class="linkClasses('games', true)">
                    <Dropdown align="right" width="48">
                        <template #trigger>
                            <span class="inline-flex rounded-md">
                                <button type="button"
                ...
                <a href="javascript:;" :class="linkClasses('schools', true)">
                    <Dropdown align="right" width="48">
                        <template #trigger>
                            <span class="inline-flex rounded-md">
                                <button type="button"
                ...
                <ResponsiveNavLink :href="route('users_panel.index')" :active="route().current('users_panel.index')">
                    Usuarios
                </ResponsiveNavLink>
            </div>
